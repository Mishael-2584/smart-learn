...
var e = {
    ...
    darkMode: function () {
        ...
        var changeThemeToDark = () => {
          ...
          if(dir == 'rtl') {
              style.setAttribute('href', 'eduport/assets/css/style-dark-rtl.css');
          } else {
              style.setAttribute('href', 'eduport/assets/css/style-dark.css');
          }
        ...
        var changeThemeToLight = () => {
          ...
          if(dir == 'rtl') {
              style.setAttribute('href', 'eduport/assets/css/style-rtl.css');
          } else {
              style.setAttribute('href', 'eduport/assets/css/style.css');
          }
