	...
	<div class="container position-relative">
		<div class="row g-4 align-items-center">
			<div class="col-md-6">
				...
				<p>Embrace the journey of learning, where every challenge becomes an opportunity to grow. With
					dedication and passion, we pave the way for a brighter tomorrow, shaping minds and nurturing dreams
				</p>
				<!-- Button -->
	...
	<div class="container">
		...
		<div class="row mb-4">
			<div class="col-sm-10 col-xl-6 text-center mx-auto">
				...
				<p class="mb-0">Are you a lecturer or an instructor and want to start teaching? Sign up now with our
					easy process and verification</p>
			</div>
		</div>
		...
		<div class="row g-4 g-md-5">
			...
			<div class="col-md-4 text-center">
				...
				<p class="text-truncate-2 mb-0">Unlock boundless learning opportunities by creating your account. Join
					our community of passionate learners and educators, where knowledge knows no bounds. Sign up now to
					embark on your educational journey with us</p>
			</div>
			...
			<div class="col-md-4 text-center">
				...
				<p class="text-truncate-2 mb-0">Get Verfied by adding your School/s that You belong to. You can add
					multiple schools. Update your profile with relevant information like your details and contacts to
					get verification.
				</p>
			</div>
			...
			<div class="col-md-4 text-center">
				...
				<p class="text-truncate-2 mb-0">Once Verified, you can start teaching by enrolling for departmental
					courses based on Your School or apply to take a General Course (GEDS) or a unique course. You will
					have to get approoved by the Admin to make sure you are qualified.</p>
			</div>
		</div> <!-- Row END -->
	</div>
</section>
		...
		<div class="bg-orange bg-opacity-10 p-4 p-sm-5 rounded position-relative overflow-hidden">
			...
			<div class="row g-4 position-relative align-items-center justify-content-center">
				...
				<div class="col-sm-6 col-lg-3 text-center">
					<div class="d-flex justify-content-center">
						<h4 class="purecounter display-6 text-orange fw-bold mb-0" data-purecounter-start="0"
							data-purecounter-end="89" data-purecounter-delay="200">0</h4>
				...
				<div class="col-sm-6 col-lg-3 text-center">
					<div class="d-flex justify-content-center">
						<h4 class="purecounter display-6 text-orange fw-bold mb-0" data-purecounter-start="0"
							data-purecounter-end="25" data-purecounter-delay="200">0</h4>
						<span class="display-6 text-orange mb-0">K</span>
					</div>
				...
				<div class="col-sm-6 col-lg-3 text-center">
					<div class="d-flex justify-content-center">
						<h4 class="purecounter display-6 text-orange fw-bold mb-0" data-purecounter-start="0"
							data-purecounter-end="180" data-purecounter-delay="200">0</h4>
						<span class="display-6 text-orange mb-0">K</span>
					</div>
				...
				<div class="col-sm-6 col-lg-3 text-center">
					<div class="d-flex justify-content-center">
						<h4 class="purecounter display-6 text-orange fw-bold mb-0" data-purecounter-start="0"
							data-purecounter-end="20" data-purecounter-delay="200">0</h4>
			...
			<div class="col-lg-7 z-index-9 mt-5 mt-xl-0">
				...
				<ul class="nav nav-pills nav-pill-soft my-4" id="course-pills-tab" role="tablist">
					...
					<li class="nav-item me-2 me-lg-4" role="presentation">
						<button class="nav-link mb-2 mb-xl-0 active" id="course-pills-tab-1" data-bs-toggle="pill"
							...
							aria-selected="true">Become an Instructor</button>
					</li>
					<!-- Tab item -->
					<li class="nav-item me-2 me-lg-4" role="presentation">
						<button class="nav-link mb-2 mb-xl-0" id="course-pills-tab-2" data-bs-toggle="pill"
							...
							aria-selected="false">Instructor Role</button>
					</li>
					<!-- Tab item -->
					<li class="nav-item me-2 me-lg-4" role="presentation">
						<button class="nav-link mb-2 mb-xl-0" id="course-pills-tab-3" data-bs-toggle="pill"
							...
							aria-selected="false">Start with Course</button>
					</li>
				</ul>
				...
				<div class="tab-content" id="pills-tabContent">
					...
					<div class="tab-pane fade show active" id="course-pills-1" role="tabpanel"
						...
						<p>Are you passionate about sharing your knowledge and expertise with eager learners? Becoming
							an instructor with Smart Learn is a rewarding opportunity to make a significant impact in
							the world of education. To start your journey, simply fill the registration form and submit
							your to be registered.</p>
						<p>Once you've register, you'll need to set up your account by filling out a comprehensive form
							where you're required to select your shools and and create a profile in order to be approved
							by admin . This form allows us to gather essential information about your background,
							qualifications, and teaching experience. Be sure to provide detailed information and
							highlight any unique skills or specialties you possess. Our team carefully reviews each
							application to ensure that we maintain the highest standards of instruction on our platform.
						</p>
						<p>After setting up your account, our dedicated team will review it thoroughly. We evaluate
							factors such as your teaching experience, subject expertise, and commitment to student
							success. If your application meets our criteria, you'll be verified as a Smart-Learn
							instructor. Congratulations! You're now ready to create engaging courses, inspire learners,
							and make a positive impact in the world of online education.</p>
					</div>

					<!-- Content -->
					<div class="tab-pane fade" id="course-pills-2" role="tabpanel" aria-labelledby="course-pills-tab-2">
						<h6>Role of Instructor</h6>
						<p>The role of an instructor goes beyond simply imparting knowledge. You'll serve as a mentor,
							motivator, and facilitator of learning, fostering a dynamic and engaging educational
							experience for your students. With your passion for teaching and dedication to student
							success, you'll inspire learners to excel and pursue their passions with confidence.

							At Smart Learn, we recognize the importance of instructors in driving meaningful learning
							outcomes. That's why we provide comprehensive support and resources to help you succeed in
							your role. As an instructor at Smart-Learn, your ar to be:
						</p>
						<!-- Info -->
						<ul class="list-group list-group-borderless mb-3">
							<li class="list-group-item">
								<i class="fas fa-check-circle text-success me-2"></i>Mentoring students to achieve their
								academic and personal goals.
							</li>
							<li class="list-group-item d-flex">
								<i class="fas fa-check-circle text-success me-2 mt-1"></i>Facilitating interactive and
								engaging learning experiences
							</li>
							<li class="list-group-item">
								<i class="fas fa-check-circle text-success me-2"></i>Providing valuable feedback and
								encouragement to foster growth and development.
							</li>
						</ul>
					</div>
					...
					<div class="tab-pane fade" id="course-pills-3" role="tabpanel" aria-labelledby="course-pills-tab-3">
						...
						<p>At Smart Learn, courses are meticulously curated
							by our dedicated team of administrators to ensure relevance and quality. Dive into our
							extensive catalog of courses spanning various disciplines, including departmental courses
							tailored to specific academic programs, general courses covering fundamental subjects, and
							unique courses designed to explore niche topics. <img src="{{ asset("
								eduport/assets/images/element/instructor-course.svg") }}"
								class="rounded float-start me-3 h-200px my-3" alt="..."> Once you've identified courses
							aligned with your expertise and teaching interests, simply select the ones you'd like to
							instruct. After selecting your desired courses, submit your enrollment request
							to the administrator for approval.
							Upon verification of your credentials and suitability for the chosen courses, you'll receive
							confirmation to proceed with instructing your selected courses. Embark on your journey to
							educate, inspire, and empower learners through engaging and enriching course experiences.
							With Smart Learn, you have the platform and resources to make a meaningful impact in the
