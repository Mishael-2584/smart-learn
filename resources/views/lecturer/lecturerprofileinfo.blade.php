...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <h2 class="section-title">Hi, @isset($lecturer) {{ $lecturer->name }} @endisset </h2>
            ...
            <div class="row mt-sm-4">
                <div class="col-12 col-md-12 col-lg-5">
                  <div class="card profile-widget">
                    ...
                    <div class="profile-widget-items">
                      ...
                      <div class="profile-widget-item">
                        <div class="profile-widget-item-label"><strong>Students</strong></div>
                        <div class="profile-widget-item-value"></div>
                      </div>
                      <div class="profile-widget-item">
                    ...
                    <div class="profile-widget-items">
                      <div class="profile-widget-item">
                        ...
                        <div class="profile-widget-item-value">
                          @if(isset($lecturer) && $lecturer->verified == 2)
                          ...
                          @elseif(isset($lecturer) && $lecturer->verified == 1)
                    ...
                    <div class="profile-widget-description">
                      ...
                      <div class="profile-widget-contact">
                        <div class="profile-widget-contact-item">
                          ...
                          <div class="profile-widget-contact-value">{{ $lecturer->email }}</div>
                        </div>
                        <br>
                        <div class="profile-widget-contact-item">
                          <div class="profile-widget-contact-label"><strong>Phone:</strong></div>
                          <div class="profile-widget-contact-value">{{ $lecturer->phone }}</div>
                        </div>
                        <br>
                        <div class="profile-widget-contact-item">
                          <div class="profile-widget-contact-label"><strong>Schools:</strong></div>
                          <div class="profile-widget-contact-value">
                            @isset($myschools)
                        ...
                        <br>
                        <div class="profile-widget-contact-item">
                          <div class="profile-widget-contact-label"><strong>Bio:</strong></div>
                          <div class="profile-widget-contact-value">
                            @php
                              echo $lecturer->bio
                            @endphp
                    ...
                    <div class="card-footer text-center">
                      <div class="font-weight-bold mb-2">Follow {{ $lecturer->name }} On</div>
                ...
                <div class="col-12 col-md-12 col-lg-7">
                    <div class="card">
                        <form method="post" action="{{ route('updatelecturerprofileinfo') }}" id="update_profile_form" class="needs-validation" novalidate="">
                            @csrf
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-12 col-12">
                                        ...
                                        <input type="text" class="form-control" value="{{$lecturer->name}}" name="name" required>
                                        <div class="invalid-feedback">Please fill in the first name</div>
                                    </div>
                                    <div class="form-group col-md-12 col-12">
                                        <label>Select Your School/(s)</label>
                                        <select id="school" name="school[]" class="form-control select2" multiple required>
                                            @isset($schools)
                                                @foreach ($schools as $school)
                                                    <option value="{{ $school->id }}" {{ in_array($school->id, $schoolIds ?? []) ? 'selected' : '' }}>
                                                        {{ $school->name }}
                                                    </option>
                                                @endforeach
                                            @endisset
                                    ...
                                    <div class="form-group col-md-6 col-12">
                                        <label>Phone</label>
                                        <input name="phone" type="tel" class="form-control" value="{{$lecturer->phone}}">
                                    </div>
                                    <div class="form-group col-md-6 col-12">
                                        <label>Twitter</label>
                                        <input name="twitter" type="text" class="form-control" value="{{$lecturer->twitter}}">
                                    </div>
                                    <div class="form-group col-md-6 col-12">
                                        <label>Facebook</label>
                                        <input name="facebook" type="text" class="form-control" value="{{$lecturer->facebook}}">
                                    </div>
                                    <div class="form-group col-md-6 col-12">
                                        <label>Instagram</label>
                                        <input name="instagram" type="text" class="form-control" value="{{$lecturer->instagram}}">
                                    </div>
                                    <div class="form-group col-md-6 col-12">
                                        <label>Linkedin</label>
                                        <input name="linkedin" type="text" class="form-control" value="{{$lecturer->linkedin}}">
                                    </div>
                                    <div class="form-group col-12">
                                        <label>Youtube</label>
                                        <input name="youtube" type="text" class="form-control" value="{{$lecturer->youtube}}">
                                    </div>
                                    <div class="form-group col-12">
                                        <label>Bio</label>
                                        <textarea name="bio" class="form-control summernote-simple">{{$lecturer->bio}}</textarea>
