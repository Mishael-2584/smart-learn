                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="myTabContent2">
                                <div class="tab-pane fade show active" id="departmental-courses" role="tabpanel" aria-labelledby="departmental-courses-tab">
                                    ...
                                    <div class="row">
                                        @foreach ($er as $e)
                                        @if (isset($e->lecturercourse->departmentcourse) && ($e->lecturercourse->lecturer->id == session()->get('id')))
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                          <article class="article">
                                              <div class="article-header">
                                                  <div class="article-image" id="backgroundimage" data-background="{{ $e->lecturercourse->departmentcourse->course->imgpath }}"></div>
                                              </div>
                                              <div class="article-title d-flex justify-content-between align-items-center">
                                                  ...
                                                  <span class="badge bg-warning text-dark" style="font-weight: bolder">{{ $pendingStudentsCounts[$e->lecturer_course_id] ?? '0' }} Pending</span>
                                              </div>
                                              <div class="article-details">
                                                  <p>{{$e->lecturercourse->departmentcourse->course->title}}</p>
                                                  <div class="article-cta">
                                                      <a href="{{route('pendingstudents', $e->lecturercourse->id)}}" class="btn btn-primary">Open</a>
                                                  </div>
                                              </div>
                                          </article>
                                ...
                                <div class="tab-pane fade" id="general-courses" role="tabpanel" aria-labelledby="general-courses-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            @foreach ($er as $e)
                                            @if (($e->lecturercourse->lecturer->id == session()->get('id')) && (isset($e->lecturercourse->course->isGEDS) == 1))
                                            <div class="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                                <article class="article @if ($gc->status == 0) dim @endif">
                                                    <div class="article-header">
                                                        <div class="article-image" id="backgroundimage" data-background="{{ $e->lecturercourse->course->imgpath }}" url=""></div>
                                                    </div>
                                ...
                                <div class="tab-pane fade" id="unique-courses" role="tabpanel" aria-labelledby="unique-courses-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            @endisset
                                            @if (($e->lecturercourse->lecturer->id == session()->get('id')) && isset($e->lecturercourse->course) && $e->lecturercourse->course->course_code == null)                                          
                                            <div class="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                                <article class="article">
                                                    <div class="article-header">
                                                        <div class="article-image" id="backgroundimage" data-background="{{ $e->lecturercourse->course->imgpath }}" url=""></div>
