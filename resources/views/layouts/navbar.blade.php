<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link nav-link-lg message-toggle beep"><i class="fa fa-envelope"></i><ion-icon name="mail-unread-outline"></ion-icon></a>
            ...
            <div class="dropdown-list-content dropdown-list-message">
                ...
                <a href="#" class="dropdown-item dropdown-item-unread">
                <div class="dropdown-item-avatar">
                    <img alt="image" src="{{ asset("codiepie/assets/img/avatar/avatar-3.png") }}" class="rounded-circle">
                    <div class="is-online"></div>
                </div>
                <div class="dropdown-item-desc">
                ...
                <div class="dropdown-item-avatar">
                    <img alt="image" src="{{ asset("codiepie/assets/img/avatar/avatar-4.png") }}" class="rounded-circle">
                </div>
                <div class="dropdown-item-desc">
                ...
                <a href="#" class="dropdown-item">
                <div class="dropdown-item-avatar">
                    <img alt="image" src="{{ asset("codiepie/assets/img/avatar/avatar-5.png") }}" class="rounded-circle">
                </div>
                <div class="dropdown-item-desc">
                    <b>Alfa Zulkarnain</b>
