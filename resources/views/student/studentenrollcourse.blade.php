                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="myTabContent2">
                                <div class="tab-pane fade show active" id="departmental-courses" role="tabpanel" aria-labelledby="departmental-courses-tab">
                                    ...
                                    <div class="row">
                                        @foreach ($lc as $c)
                                        @if ($c->departmentcourse->department->school->id == $student->major->department->school->id)
                                                <div class="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                                    <article class="article">
                                                        <div class="article-header">

                                                            <div class="article-image" id="backgroundimage" data-background="{{ $c->departmentcourse->course->imgpath }}" url=""></div>

                                                        </div>
                                                        <div class="article-title">
                                                            <h4 id="heading">{{$c->departmentcourse->course->course_code}}</h4>
                                                            <h5 id="heading">By: {{$c->lecturer->name}}</h5>
                                                        </div>
                                                        <div class="article-details">
                                                            <p>{{$c->departmentcourse->course->title}}</p>
                                                            <div class="article-cta">
                                                                <a href="{{ route('studentenrolldept', $c->id)}}" class="btn btn-primary">Enroll</a>
                                                            </div>
                                                        </div>
                                                    </article>
                                                </div> 
                                ...
                                <div class="row"> 
                                    ...
                                    @if ($c->course->isGEDS==1 && (substr($c->course->course_code, 5, 1) === substr($student->level, 0, 1)))
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                            <article class="article">
                                                ...
                                                <div class="article-details">
                                                    <p>{{$c->course->title}}</p>
                                                    <div class="article-cta">
                                                        <a href="{{ route('studentenrollgeds', $c->id)}}" class="btn btn-primary">Enroll</a>
                                                    </div>
                                                </div>
                                            </article>
                                        </div>
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                            <article class="article">
                                                ...
                                                <div class="article-details">
                                                    <p>{{$c->course->title}}</p>
                                                    <div class="article-cta">
                                                        <a href="{{ route('studentenrollunique', $c->id)}}" class="btn btn-primary">Enroll</a>
                                                    </div>
                                                </div>
                                            </article>
                                        </div>
