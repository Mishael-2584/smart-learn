                            ...
                            <div class="tab-content" id="myTabContent2">
                                ...
                                <div class="tab-pane fade" id="general-courses" role="tabpanel" aria-labelledby="general-courses-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            @foreach ($er as $e)
                                            @if (isset($e->lecturercourse->course) && $e->lecturercourse->course->isGEDS == 1)
                                ...
                                <div class="tab-pane fade" id="unique-courses" role="tabpanel" aria-labelledby="unique-courses-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            @foreach ($er as $e)
                                            @if (isset($e->lecturercourse->course) && $e->lecturercourse->course->isGEDS == 0)
                                            ...
                                            <div class="col-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                                                <article class="article @if ($e->status == 1) dim @endif">
                                                    ...
                                                    <div class="article-title">
                                                        <h5 id="heading">By: {{$e->lecturercourse->course->lecturer->name}}</h5><h4 id="heading">{{$uc->course->course_code}}</h4>
                                                    </div>
                                                    <div class="article-details">
                                                        <p>{{$gc->course->title}}</p>
                                                        <div class="article-cta">
